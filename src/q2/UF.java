...
/**
 *  The {@code UF} class represents a <em>union每find data type</em>
 ...
 *  <p>
 *  The union每find data type models connectivity among a set of <em>n</em>
 *  sites, named 0 through <em>n</em>每1.
...
public class UF {
    ...
    /**
     * Initializes an empty union每find data structure with {@code n} sites
